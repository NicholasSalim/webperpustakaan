<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background-color: #2c3e50;" href="/">
        <div class="sidebar-brand-icon">
            <img src="{{ asset('/img/amirhamzahlogo.png') }}" style="height:100%;">
        </div>
        <div class="sidebar-brand-text mx-2">YPI Amir Hamzah</div>
    </a>
