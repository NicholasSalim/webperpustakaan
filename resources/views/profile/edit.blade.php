...
@section('judul')
    <h3 style="color:#1abc9c;">Edit Profil</h3>
@endsection
...
@section('content')
    <form action="/profile/{{$profile->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card pb-5">
            ...
            <div class="form-group mx-4 my-2">
                <label for="photoProfile" class="text-md  font-weight-bold" style="color:#1abc9c;">Tambah Foto Profil</label>
            ...
            <div class="button-save d-flex justify-content-end">
                ...
                <button type="submit"class="btn btn-primary mt-4 mx-2 px-5 py-1" style="background-color:#1abc9c; border-style:none">Simpan</button>
    </form>
    </div>
    </div>
@endsection
